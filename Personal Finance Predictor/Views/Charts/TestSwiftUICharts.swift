    ...
    var body: some View {
        VStack {
            RangedLineChart(chartData: data)
                ...
                .touchOverlay(chartData: data, specifier: "%.0f", unit: .prefix(of: "$"), minDistance: 50)
...
extension TestSwiftUICharts {
    static func weekOfData() -> RangedLineChartData {
        let data = RangedLineDataSet(dataPoints: [
            ...
            RangedLineChartDataPoint(value: 124432, upperValue: 134441, lowerValue: 112342, xAxisLabel: "2015")
        ],
        legendTitle: "Profits",
...
struct TestSwiftUICharts_Previews: PreviewProvider {
